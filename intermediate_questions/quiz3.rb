...
puts "(3)"
puts "my string = /"pumpkins/"; my array = /["pumpkins/"]" 
puts "the string opperator += creates a new string and returns it while the << operator modifies the array."
...
puts "(5)"
puts "since ruby automatically evaluates statements you don't need the if else structure"
